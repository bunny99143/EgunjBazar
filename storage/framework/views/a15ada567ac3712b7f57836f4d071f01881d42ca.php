...
@media  screen and (max-width: 600px) {
  ...
  <div class="row">
    ...
    <form action="<?php echo e(url('/contact_us')); ?>" method="post" style="display: inline-block;">
    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\EgunjBazar\resources\views/contact_us.blade.php ENDPATH**/ ?>