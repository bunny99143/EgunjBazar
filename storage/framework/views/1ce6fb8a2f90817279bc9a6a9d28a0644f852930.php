                ...
                <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Login</label> <input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab">Sign Up</label>
                    ...
                    <div class="login-space">
                        ...
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="group"> <label for="user" class="label">Username</label> <input id="user" type="text" class="input" name="email" placeholder="Enter your Email"> </div>
                        ...
                        <form method="POST" action="<?php echo e(url('register')); ?>" class="registration-form">
                        <?php echo csrf_field(); ?>
                        <div class="group"> <label for="f_name" class="label">First Name</label> <input id="f_name" type="text" class="input" name="f_name" placeholder="Please enter first name"> </div>
                            ...
                            <div class="group"> <label for="pass" class="label">Password</label> <input id="pass" type="password" class="input" name="password"  data-type="password" placeholder="Please enter your password"> </div>
...
</html><?php /**PATH C:\xampp\htdocs\testlaravel\resources\views/login.blade.php ENDPATH**/ ?>