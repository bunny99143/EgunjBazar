...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <li class="nav-item ">
                  ...
                  <li class="nav-item ">
                        <a class="nav-link" href="<?php echo e(url('/')); ?>">About Us</a>
                    </li>
                    <li class="nav-item ">
    ...
    <section class="slice" style="padding-top: 0; padding-bottom: 0;">
        <!-- <div class="container"> -->
        <img alt="Image placeholder" src="<?php echo e(asset('images/home/main_page.jpg')); ?>" style="width: 100%;height: 600px;">
        <!-- </div> -->
    </section>
            ...
            <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <a href="<?php echo e(url('/products/'.$item->id)); ?>">
                            <div class="pt-4 pb-5">
                                <img src="<?php echo e(asset('images/category_image/')."/".$item->category_image); ?>" class="img-fluid img-center" style="height: 200px;" alt="Illustration" />
                            </div>
                            <h5 class="h4 lh-130 mb-3"><?php echo e($item->category_name); ?></h5>
                            <p class="text-muted mb-0"><?php echo e($item->category_desc); ?></p>
                        </div>
                        </a>
                    </div>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\EgunjBazar\resources\views/welcome.blade.php ENDPATH**/ ?>